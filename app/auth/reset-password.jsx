...
const styles = StyleSheet.create({
  ...
  logoCircle: { width: 150, height: 150, borderRadius: 75, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', elevation: 10, padding: 10 },
  logo: { width: 120, height: 70 },
  brandName: { fontSize: 28, fontWeight: 'bold', color: '#fff', display: 'none' },
